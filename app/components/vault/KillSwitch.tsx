...
export function KillSwitch({ vault, onRevoke, onSuccess }: Props) {
  ...
  return (
    <div className="bg-[#050505] border border-blue-500/20 rounded-[2.5rem] overflow-hidden shadow-[0_0_50px_rgba(0,0,0,1)] relative">
      {/* Decorative Glow */}
      ...
      <div className="p-10 relative z-10">
        <div className="flex items-start justify-between mb-10">
          ...
          <div className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-[0.25em] border animate-pulse shadow-[0_0_15px_rgba(0,0,0,0.5)] ${
            isFrozen 
        ...
        {isFrozen && (
          <div className="mb-10 p-8 rounded-3xl bg-red-950/10 border border-red-500/20 relative overflow-hidden">
            ...
            <p className="text-[12px] text-red-200/40 leading-relaxed font-medium">
        ...
        {!isFrozen && (
          <div className="mb-10 space-y-5">
            <div className="flex items-center gap-4">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-500/40">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3 p-4 rounded-2xl bg-blue-500/[0.02] border border-blue-500/5 group hover:border-blue-500/20 transition-all">
                  <Zap size={12} className="text-blue-500/20 group-hover:text-blue-400 transition-colors" />
                  <span className="text-[11px] font-bold text-blue-100/40 group-hover:text-blue-100/70 transition-colors uppercase tracking-tight">{text}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {!isFrozen ? (
          <button
            ...
            className="w-full py-5 rounded-[1.5rem] bg-red-600 border-t border-red-400 text-white transition-all font-black uppercase tracking-[0.3em] text-xs shadow-[0_20px_50px_rgba(220,38,38,0.2)] hover:shadow-[0_25px_60px_rgba(220,38,38,0.4)] hover:-translate-y-1 active:translate-y-0 active:scale-[0.98]"
          >
            Purge_Agent_Authority
          </button>
        ) : (
          <div className="p-8 rounded-3xl bg-blue-500/[0.02] border border-blue-500/10">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-4 text-[11px] font-bold text-blue-100/30 uppercase tracking-tight">
