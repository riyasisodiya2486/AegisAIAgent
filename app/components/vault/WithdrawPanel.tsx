...
export function WithdrawPanel({ vault, onWithdraw }: Props) {
  ...
  return (
    <div className="bg-[#050505] border border-blue-500/15 rounded-3xl md:rounded-[2.5rem] overflow-hidden shadow-[0_0_50px_rgba(0,0,0,1)] relative">
      ...
      <div className="p-6 md:p-10 relative z-10">
        ...
        {vault && (
          <div className="space-y-4 mb-6 md:mb-10 p-5 md:p-8 rounded-2xl md:rounded-3xl bg-blue-500/[0.02] border border-blue-500/5">
            {[
              ...
              <div key={i} className="flex items-center justify-between group">
                <div className="flex flex-col">
                  <span className={`text-[9px] md:text-[10px] font-black uppercase tracking-widest ${bold ? "text-cyan-400" : "text-blue-100/30"}`}>
                    {label}
                  </span>
                  <span className="text-[7px] md:text-[8px] font-mono text-blue-500/20 uppercase tracking-tighter mt-0.5">{note}</span>
                </div>
                <div className={`text-xs md:text-sm font-mono font-bold ${bold ? "text-cyan-400" : "text-blue-100/70"}`}>
        ...
        {/* Technical Warning */}
        <div className="mb-6 md:mb-10 flex gap-4 p-4 md:p-5 rounded-xl md:rounded-2xl bg-blue-500/[0.03] border border-blue-500/10">
          <AlertTriangle className="text-blue-500/40 shrink-0" size={18} />
          <p className="text-[10px] md:text-[11px] font-medium text-blue-100/40 leading-relaxed uppercase tracking-tight">
